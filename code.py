...
# Step 1: Load Dataset
# ======================
input_file = r"D:\My Files\Coding\Python\Dataset\tech_layoffs_til_2025.csv"
...
# ======================
# Step 3: Monthly Total Layoffs (SUM of employees)
# ======================
...
plt.tight_layout()
plt.savefig(r"D:\My Files\Coding\Python\Dataset\Output\monthly_total_layoffs.png")
plt.close()
...
plt.tight_layout()
plt.savefig(r"D:\My Files\Coding\Python\Dataset\Output\top_10_companies_total_layoffs.png")
plt.close()
...
plt.tight_layout()
plt.savefig(r"D:\My Files\Coding\Python\Dataset\Output\industry_total_layoffs.png")
plt.close()
...
monthly.to_excel(r"D:\My Files\Coding\Python\Dataset\Output\monthly_summary.xlsx", index=False)
top_companies.to_excel(r"D:\My Files\Coding\Python\Dataset\Output\top_companies_summary.xlsx")
industry_totals.to_excel(r"D:\My Files\Coding\Python\Dataset\Output\industry_summary.xlsx")
